...
import { createProduct,getAllProducts,getById,editproduct,deleteProduct,getByVariantSku } from '../../../controllers/admin/product/product.controller.js';
...
router.get('/getBySku',getByVariantSku)
